...
title: Silabus Materi KSN 2021 Bidang Informatika
key: syllabus
---

Materi KSN bidang informatika/komputer yang akan diujikan mengacu pada silabus IOI 2021 dengan berbagai penyesuaian.

Perbedaan dengan [Silabus Materi KSN Informatika 2020](https://ksn2020.toki.id/silabus.html) ditandai <span style="color:red">warna merah</span>.
...
8. **Struktur Data**
   ...
   * *Binary heap*
   * *Disjoint set*
   * <span style="color:red"><em>Segment tree (point update range query)</em></span>
...
10. **Geometri Dasar**
   ...
   * Jarak Euclidean
   * Teorema Pythagoras
   * <span style="color:red"><em>Convex Hull</em> (algoritme Graham scan, algoritme Monotone chain)</span>
